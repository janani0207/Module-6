...
print(ob1 < ob2)
## Output
<img width="944" height="170" alt="image" src="https://github.com/user-attachments/assets/9a8591c6-60d2-4842-965c-d8a48a1d2fb6" />
...
for i in (obj_beans,obj_mango):
    ...
    i.color()
## Output
<img width="945" height="231" alt="image" src="https://github.com/user-attachments/assets/65707996-3ed1-4130-afa4-fcaed13e73cc" />
